...
- **20 built-in checks** covering security, SEO, performance, accessibility, and technology detection
...
Site Inspector runs 20 checks organized into five categories. All checks run in parallel and return structured data.
